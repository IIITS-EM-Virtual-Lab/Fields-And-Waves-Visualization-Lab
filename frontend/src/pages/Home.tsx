...
const Home = () => {
  ...
  const topicData = [
    { image: "/assets/vector-algebra.png", title: "Vector Algebra" },
    { image: "/assets/vector-calculus.png", title: "Vector Calculus" },
    { image: "/assets/electrostatics.png", title: "Electrostatics" },
    { image: "/assets/maxwell.png", title: "Maxwell Equations" },
    { image: "/assets/wave.gif", title: "Wave Propagation" },
  ];
  ...
  return (
    <main className="px-12">
      ...
      <div id="about" className="mt-44 flex flex-col gap-6 items-center">
      ...
      {/* ✅ Added id="modules" to enable scroll */}
      <div id="modules" className="my-20">
        ...
        <div className="flex flex-wrap gap-8 justify-center my-10">
          {topicData.map((card, index) => (
            <Link to={`/content/${index + 1}`} key={index}>
              <Button className="bg-white shadow-lg p-36 flex flex-col gap-4 h-20 text-black hover:text-white">
                <div>
