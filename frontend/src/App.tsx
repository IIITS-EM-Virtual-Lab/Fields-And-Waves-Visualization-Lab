      ...
      <div className="pt-20">
        <Routes>
          ...
          <Route element={<ContentLayout />}>
            ...
            <Route path="/electric-field-and-flux-density" element={<ProtectedRoute><ElectricDipolePage /></ProtectedRoute>} />
            <Route path="/field-operations" element={<ProtectedRoute><ElectricFluxPage /></ProtectedRoute>} />
            ...
            <Route path="/electric-dipole" element={<ProtectedRoute><GradientPage /></ProtectedRoute>} />
